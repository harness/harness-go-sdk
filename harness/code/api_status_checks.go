...
func (a *StatusChecksApiService) ListStatusCheckRecent(ctx context.Context, repoRef string, localVarOptionals *StatusChecksApiListStatusCheckRecentOpts) ([]string, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/repos/{repo_ref}/checks/recent"
...
func (a *StatusChecksApiService) ListStatusCheckResults(ctx context.Context, repoRef string, commitSha string, localVarOptionals *StatusChecksApiListStatusCheckResultsOpts) ([]TypesCheck, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/repos/{repo_ref}/checks/commits/{commit_sha}"
	localVarPath = strings.Replace(localVarPath, "{"+"repo_ref"+"}", fmt.Sprintf("%v", repoRef), -1)
...
func (a *StatusChecksApiService) ReportStatusCheckResults(ctx context.Context, repoRef string, commitSha string, localVarOptionals *StatusChecksApiReportStatusCheckResultsOpts) (TypesCheck, *http.Response, error) {
	var (
