...
/*
CloudCostAutoStoppingRulesV2ApiService Return AutoStopping Rule details in V2 format
Returns details of an AutoStopping Rule for the given identifier in V2 format.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param accountId Account Identifier for the Entity
...
*/
func (a *CloudCostAutoStoppingRulesV2ApiService) GetAutoStoppingRuleV2(ctx context.Context, accountId string, ruleId float64, accountIdentifier string) (InlineResponse2001, *http.Response, error) {
	var (
