...
*EnvironmentsApi* | [**MoveEnvironmentConfigs**](docs/EnvironmentsV2Api.md#moveenvironmentconfigs) | **Post** /ng/api/environmentsV2/move-config/{environmentIdentifier} | Move environment YAML from inline to remote
