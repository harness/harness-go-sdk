...
*SloApi* | [**DeleteSLODataNg**](docs/SloApi.md#deleteslodatang) | **Delete** /account/{accountIdentifier}/org/{orgIdentifier}/project/{projectIdentifier}/identifier/{identifier}/slo/v2 | delete slo data
*SloApi* | [**GetServiceLevelObjectiveNg**](docs/SloApi.md#getservicelevelobjectiveng) | **Get** /account/{accountIdentifier}/org/{orgIdentifier}/project/{projectIdentifier}/identifier/{identifier}/slo/v2 | get service level objective data
...
*SloApi* | [**UpdateSLODataNg**](docs/SloApi.md#updateslodatang) | **Put** /account/{accountIdentifier}/org/{orgIdentifier}/project/{projectIdentifier}/identifier/{identifier}/slo/v2 | update slo data
