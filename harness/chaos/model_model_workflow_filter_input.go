...
type ModelWorkflowFilterInput struct {
	// Date range for filtering purpose
	DateRange *AllOfmodelWorkflowFilterInputDateRange `json:"dateRange,omitempty"`
	...
	ScenarioType *AllOfmodelWorkflowFilterInputScenarioType `json:"scenarioType,omitempty"`
	// Status of the latest workflow run
	Status *AllOfmodelWorkflowFilterInputStatus `json:"status,omitempty"`
	// Tags based search
