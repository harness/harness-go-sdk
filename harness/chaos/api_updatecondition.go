...
type UpdateconditionApiService service

/*
UpdateconditionApiService updates a chaos guard condition
updates a chaos guard condition
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body update condition request
 * @param accountIdentifier account id to access the resource
 * @param identity The identifier for the condition
 * @param optional nil or *UpdateconditionApiUpdateConditionOpts - Optional Parameters:
...
@return ChaosguardconditionsUpdateConditionResponse
*/

type UpdateconditionApiUpdateConditionOpts struct {
	CorrelationID          optional.String
	OrganizationIdentifier optional.String
	ProjectIdentifier      optional.String
}

func (a *UpdateconditionApiService) UpdateCondition(ctx context.Context, body SecurityGovernanceCondition, accountIdentifier string, identity string, localVarOptionals *UpdateconditionApiUpdateConditionOpts) (ChaosguardconditionsUpdateConditionResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ChaosguardconditionsUpdateConditionResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ChaosguardconditionsUpdateConditionResponse
