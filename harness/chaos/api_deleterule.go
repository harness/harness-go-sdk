...
type DeleteruleApiService service
/*
DeleteruleApiService deletes a chaos guard rule
 ...
 * @param optional nil or *DeleteruleApiDeleteRuleOpts - Optional Parameters:
...
@return ChaosguardrulesDeleteRuleResponse
*/

type DeleteruleApiDeleteRuleOpts struct {
    CorrelationID optional.String
    OrganizationIdentifier optional.String
    ProjectIdentifier optional.String
}

func (a *DeleteruleApiService) DeleteRule(ctx context.Context, accountIdentifier string, identity string, localVarOptionals *DeleteruleApiDeleteRuleOpts) (ChaosguardrulesDeleteRuleResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ChaosguardrulesDeleteRuleResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ChaosguardrulesDeleteRuleResponse
