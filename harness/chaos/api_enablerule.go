...
type EnableruleApiService service
/*
EnableruleApiService enables or disables a chaos guard rule
 ...
 * @param optional nil or *EnableruleApiEnableRuleOpts - Optional Parameters:
...
type EnableruleApiEnableRuleOpts struct {
    CorrelationID optional.String
    OrganizationIdentifier optional.String
    ProjectIdentifier optional.String
}

func (a *EnableruleApiService) EnableRule(ctx context.Context, accountIdentifier string, identity string, enabled bool, localVarOptionals *EnableruleApiEnableRuleOpts) (string, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v3/chaosguard-rules/{identity}/enable"
