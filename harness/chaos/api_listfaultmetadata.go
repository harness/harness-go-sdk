...
type ListfaultmetadataApiService service

/*
ListfaultmetadataApiService lists fault metadata
lists fault metadata
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body list fault request body
 * @param accountIdentifier account id to access the resource
 * @param optional nil or *ListfaultmetadataApiListFaultMetadataOpts - Optional Parameters:
...
type ListfaultmetadataApiListFaultMetadataOpts struct {
...
func (a *ListfaultmetadataApiService) ListFaultMetadata(ctx context.Context, body TypesListMetadataRequest, accountIdentifier string, localVarOptionals *ListfaultmetadataApiListFaultMetadataOpts) (SharedListMetadataResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v3/faults/list-metadata"
