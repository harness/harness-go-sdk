...
type ListexperimentmetadataApiService service

/*
ListexperimentmetadataApiService lists experiment metadata
lists experiment metadata
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body list experiment request body
 * @param accountIdentifier account id to access the resource
 * @param optional nil or *ListexperimentmetadataApiListExperimentMetadataOpts - Optional Parameters:
...
type ListexperimentmetadataApiListExperimentMetadataOpts struct {
...
func (a *ListexperimentmetadataApiService) ListExperimentMetadata(ctx context.Context, body TypesListMetadataRequest, accountIdentifier string, localVarOptionals *ListexperimentmetadataApiListExperimentMetadataOpts) (SharedListMetadataResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v3/experiments/list-metadata"
