...
type ListactionmetadataApiService service

/*
ListactionmetadataApiService lists action metadata
lists action metadata
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body list action request body
 * @param accountIdentifier account id to access the resource
 * @param optional nil or *ListactionmetadataApiListActionMetadataOpts - Optional Parameters:
...
type ListactionmetadataApiListActionMetadataOpts struct {
...
func (a *ListactionmetadataApiService) ListActionMetadata(ctx context.Context, body TypesListMetadataRequest, accountIdentifier string, localVarOptionals *ListactionmetadataApiListActionMetadataOpts) (SharedListMetadataResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v3/actions/list-metadata"
