...
type DeleteconditionApiService service
/*
DeleteconditionApiService deletes a chaos guard condition
 ...
 * @param optional nil or *DeleteconditionApiDeleteConditionOpts - Optional Parameters:
...
@return ChaosguardconditionsDeleteConditionResponse
*/

type DeleteconditionApiDeleteConditionOpts struct {
    CorrelationID optional.String
    OrganizationIdentifier optional.String
    ProjectIdentifier optional.String
}

func (a *DeleteconditionApiService) DeleteCondition(ctx context.Context, accountIdentifier string, identity string, localVarOptionals *DeleteconditionApiDeleteConditionOpts) (ChaosguardconditionsDeleteConditionResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ChaosguardconditionsDeleteConditionResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ChaosguardconditionsDeleteConditionResponse
