...
type GetruleApiService service
/*
GetruleApiService gets a chaos guard rule by id
 ...
 * @param optional nil or *GetruleApiGetRuleOpts - Optional Parameters:
...
@return ChaosguardrulesGetRuleResponse
*/

type GetruleApiGetRuleOpts struct {
    CorrelationID optional.String
    OrganizationIdentifier optional.String
    ProjectIdentifier optional.String
}

func (a *GetruleApiService) GetRule(ctx context.Context, accountIdentifier string, identity string, localVarOptionals *GetruleApiGetRuleOpts) (ChaosguardrulesGetRuleResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ChaosguardrulesGetRuleResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ChaosguardrulesGetRuleResponse
