...
type ListhubmetadataApiService service

/*
ListhubmetadataApiService lists hub metadata
lists hub metadata
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body list hub request body
 * @param accountIdentifier account id to access the resource
 * @param optional nil or *ListhubmetadataApiListHubMetadataOpts - Optional Parameters:
...
type ListhubmetadataApiListHubMetadataOpts struct {
...
func (a *ListhubmetadataApiService) ListHubMetadata(ctx context.Context, body TypesListMetadataRequest, accountIdentifier string, localVarOptionals *ListhubmetadataApiListHubMetadataOpts) (SharedListMetadataResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v3/hubs/list-metadata"
