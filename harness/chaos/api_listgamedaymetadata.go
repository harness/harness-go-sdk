...
type ListgamedaymetadataApiService service

/*
ListgamedaymetadataApiService lists gameday metadata
lists gameday metadata
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body list gameday request body
 * @param accountIdentifier account id to access the resource
 * @param optional nil or *ListgamedaymetadataApiListGamedayMetadataOpts - Optional Parameters:
...
type ListgamedaymetadataApiListGamedayMetadataOpts struct {
...
func (a *ListgamedaymetadataApiService) ListGamedayMetadata(ctx context.Context, body TypesListMetadataRequest, accountIdentifier string, localVarOptionals *ListgamedaymetadataApiListGamedayMetadataOpts) (SharedListMetadataResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v3/gamedays/list-metadata"
