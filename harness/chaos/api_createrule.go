...
type CreateruleApiService service

/*
CreateruleApiService creates a chaos guard rule
creates a chaos guard rule
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body create rule request
 * @param accountIdentifier account id to access the resource
 * @param optional nil or *CreateruleApiCreateRuleOpts - Optional Parameters:
...
@return ChaosguardrulesCreateRuleResponse
*/

type CreateruleApiCreateRuleOpts struct {
	CorrelationID          optional.String
	OrganizationIdentifier optional.String
	ProjectIdentifier      optional.String
}

func (a *CreateruleApiService) CreateRule(ctx context.Context, body ChaosguardrulesCreateRuleRequest, accountIdentifier string, localVarOptionals *CreateruleApiCreateRuleOpts) (ChaosguardrulesCreateRuleResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ChaosguardrulesCreateRuleResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/chaosguard-rules"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ChaosguardrulesCreateRuleResponse
