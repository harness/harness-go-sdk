...
type CreateconditionApiService service

/*
CreateconditionApiService creates a chaos guard condition
creates a chaos guard condition
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body create condition request
 * @param accountIdentifier account id to access the resource
 * @param optional nil or *CreateconditionApiCreateConditionOpts - Optional Parameters:
...
@return ChaosguardconditionsCreateConditionResponse
*/

type CreateconditionApiCreateConditionOpts struct {
	CorrelationID          optional.String
	OrganizationIdentifier optional.String
	ProjectIdentifier      optional.String
}

func (a *CreateconditionApiService) CreateCondition(ctx context.Context, body ChaosguardconditionsCreateConditionRequest, accountIdentifier string, localVarOptionals *CreateconditionApiCreateConditionOpts) (ChaosguardconditionsCreateConditionResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ChaosguardconditionsCreateConditionResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/chaosguard-conditions"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ChaosguardconditionsCreateConditionResponse
