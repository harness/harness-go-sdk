...
type AllOfv1ServiceSpecType_ string

const (
	ServiceSpecTypeClusterIP    AllOfv1ServiceSpecType_ = "ClusterIP"
	ServiceSpecTypeExternalName AllOfv1ServiceSpecType_ = "ExternalName"
	ServiceSpecTypeNodePort     AllOfv1ServiceSpecType_ = "NodePort"
	ServiceSpecTypeLoadBalancer AllOfv1ServiceSpecType_ = "LoadBalancer"
)

func (v AllOfv1ServiceSpecType_) String() string {
	return string(v)
}
