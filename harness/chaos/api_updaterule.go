...
type UpdateruleApiService service

/*
UpdateruleApiService updates a chaos guard rule
updates a chaos guard rule
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body update rule request
 * @param accountIdentifier account id to access the resource
 * @param identity The identifier for the rule
 * @param optional nil or *UpdateruleApiUpdateRuleOpts - Optional Parameters:
...
@return ChaosguardrulesUpdateRuleResponse
*/

type UpdateruleApiUpdateRuleOpts struct {
	CorrelationID          optional.String
	OrganizationIdentifier optional.String
	ProjectIdentifier      optional.String
}

func (a *UpdateruleApiService) UpdateRule(ctx context.Context, body GithubComHarnessHceSaasGraphqlServerPkgDatabaseMongodbSecurityGovernanceRule, accountIdentifier string, identity string, localVarOptionals *UpdateruleApiUpdateRuleOpts) (ChaosguardrulesUpdateRuleResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ChaosguardrulesUpdateRuleResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v3/chaosguard-rules/{identity}"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ChaosguardrulesUpdateRuleResponse
