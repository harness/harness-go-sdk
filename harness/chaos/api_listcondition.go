...
type ListconditionApiService service
/*
ListconditionApiService lists chaos guard conditions
lists chaos guard conditions
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountIdentifier account id to access the resource
 * @param optional nil or *ListconditionApiListConditionOpts - Optional Parameters:
     * @param "CorrelationID" (optional.String) -  correlation id is used to debug micro svc communication
     * @param "InfrastructureType" (optional.String) - 
...
@return ChaosguardconditionsListConditionResponse
*/

type ListconditionApiListConditionOpts struct {
...
func (a *ListconditionApiService) ListCondition(ctx context.Context, accountIdentifier string, localVarOptionals *ListconditionApiListConditionOpts) (ChaosguardconditionsListConditionResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ChaosguardconditionsListConditionResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ChaosguardconditionsListConditionResponse
