...
type ListruleApiService service
/*
ListruleApiService lists chaos guard rules
lists chaos guard rules
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountIdentifier account id to access the resource
 * @param optional nil or *ListruleApiListRuleOpts - Optional Parameters:
...
@return ChaosguardrulesListRuleResponse
*/

type ListruleApiListRuleOpts struct {
...
func (a *ListruleApiService) ListRule(ctx context.Context, accountIdentifier string, localVarOptionals *ListruleApiListRuleOpts) (ChaosguardrulesListRuleResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ChaosguardrulesListRuleResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ChaosguardrulesListRuleResponse
