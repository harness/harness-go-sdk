...
func (c *APIClient) callAPI(request *retryablehttp.Request) (*http.Response, error) {
	if c.cfg.Debug {
		tempRequest, err := http.NewRequest(request.Method, request.URL.Path, request.Body)
		dump, err := httputil.DumpRequestOut(tempRequest, true)
		if err != nil {
			return nil, err
		}
		log.Printf("\n%s\n", string(dump))
	...
	newRequest, err := retryablehttp.NewRequest(request.Method, request.URL.Path, request.Body)
	resp, err := c.cfg.HTTPClient.Do(newRequest)
	if err != nil {
		return resp, err
	}
...
func (c *APIClient) prepareRequest(
	...
	formFiles []formFile) (localVarRequest *retryablehttp.Request, err error) {
