...
// checks if the InlineResponse20024 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InlineResponse20024{}
...
type _InlineResponse20024 InlineResponse20024
...
func (o InlineResponse20024) ToMap() (map[string]interface{}, error) {
...
func (o *InlineResponse20024) UnmarshalJSON(data []byte) (err error) {
	...
	varInlineResponse20024 := _InlineResponse20024{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInlineResponse20024)

	if err != nil {
		return err
	}

	*o = InlineResponse20024(varInlineResponse20024)
